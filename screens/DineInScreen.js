...
const DineInScreen = () => {
    ...
    const addTable = async () => {
        if (!tableName || !capacity) {
            Alert.alert('Error', 'Please fill name and capacity');
            return;
        }
        try {
        ...
        <SafeAreaView className="flex-1 bg-white dark:bg-slate-900">
            ...
            >
                <View className="mb-6 flex-row justify-between items-center">
                    <View>
                        <Text className="text-2xl font-bold text-slate-900 dark:text-white">Dine In</Text>
                        <Text className="text-slate-500 dark:text-slate-400">Manage table reservations</Text>
                    </View>
                    <Switch
                        value={isEnabled}
                ...
                <View className="mb-6">
                    <View className="flex-row justify-between items-center mb-4">
                        <Text className="text-xl font-bold text-slate-900 dark:text-white">Available Time Slots</Text>
                        <TouchableOpacity className="bg-orange-100 dark:bg-orange-900/30 px-3 py-1 rounded-full">
                            <Text className="text-orange-600 dark:text-orange-400 font-bold text-xs">Edit</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View className="flex-row justify-between items-center mb-4">
                    <Text className="text-xl font-bold text-slate-900 dark:text-white">Tables</Text>
                    <TouchableOpacity
                ...
                {tables.length === 0 ? (
                    <View className="items-center justify-center py-20 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-dashed border-slate-300 dark:border-slate-700">
                        ...
                        <Text className="text-slate-400 mt-4">No tables added yet</Text>
                    </View>
                ) : (
                    tables.map((table) => (
                            ...
                            <View className="flex-row items-center flex-1">
                                ...
                                <View>
                                    ...
                                    <View className="flex-row items-center">
                                        ...
                                        <Text className="text-slate-400 text-sm ml-1">{table.seats} Seats</Text>
            ...
            >
                <View className="flex-1 justify-end bg-black/50">
                    <View className="bg-white dark:bg-slate-900 p-6 rounded-t-3xl">
                        <Text className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Add New Table</Text>

                        <Text className="text-slate-600 dark:text-slate-400 mb-2">Table Name</Text>
                        <TextInput
                        ...
                        <View className="flex-row justify-between">
                            <View className="w-[48%]">
                                <Text className="text-slate-600 dark:text-slate-400 mb-2">Capacity</Text>
                                <TextInput
                            ...
                            <View className="w-[48%]">
                                <Text className="text-slate-600 dark:text-slate-400 mb-2">Price</Text>
                                <TextInput
                                    className="bg-slate-100 dark:bg-slate-800 p-4 rounded-xl mb-4 text-slate-900 dark:white"
                                    placeholder="$0.00"
                                    keyboardType="numeric"
                        ...
                        <Text className="text-slate-600 dark:text-slate-400 mb-2">Table Image</Text>
                        <TouchableOpacity
                            onPress={pickImage}
                        ...
                        >
                            {image ? (
                                ...
                                <View className="items-center">
                                    ...
                                    <Text className="text-slate-400 mt-1">Add Photo</Text>
                                </View>
                            )}
                        </TouchableOpacity>
                        ...
                        <View className="flex-row justify-between mt-4">
                            ...
                            >
                                <Text className="text-center font-bold text-slate-600 dark:text-slate-400">Cancel</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                onPress={addTable}
                                className="bg-orange-500 p-4 rounded-xl w-[48%]"
                            >
                                <Text className="text-center font-bold text-white">Add Table</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
